...
def train_mps(learning_rate,do_save_model:bool):
  ...
  dataloader = DataLoader(train_data,batch_size=learning_batch_size,shuffle=True)
...
def train_DDP(rank,learning_rate,do_save_model:bool):
  ...
  dataloader = DataLoader(train_data,batch_size=learning_batch_size,sampler=sampler)
